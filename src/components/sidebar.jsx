        ...
        <div>
          ...
          <aside id="colorlib-aside" className="border js-fullheight">
            <div className="text-center">
              <div className="author-img" style={{backgroundImage: 'url(images/dongming.jpg)'}} />
              <h1 id="colorlib-logo"><a href="index.html">DongMing Zheng</a></h1>
              <span className="email"><i className="icon-mail"></i> dongming0401@gmail.com</span>
            </div>
            ...
            <nav id="colorlib-main-menu">
              <ul>
                ...
                <li><a href="https://twitter.com/dongming0401" target="_blank" rel="noopener noreferrer"><i className="icon-twitter2" /></a></li>
                <li><a href="https://www.instagram.com/dongming0401/" target="_blank" rel="noopener noreferrer"><i className="icon-instagram" /></a></li>
